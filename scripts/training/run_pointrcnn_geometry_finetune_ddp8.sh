...
CFG="../../integrations/openpcdet/configs/kitti_models/pointrcnn_fov_geometry.yaml"
PRETRAINED="ckpt/pointrcnn_7870.pth"
TAG="pointrcnn_geometry_from_7870_ddp8"
OUT="${ROOT}/output/kitti_models/pointrcnn_fov_geometry/${TAG}"
