...
CFG="../../integrations/openpcdet/configs/kitti_models/second_fov_geometry.yaml"
PRETRAINED="ckpt/second_7862.pth"
TAG="second_geometry_from_7862_ddp8"
OUT="${ROOT}/output/kitti_models/second_fov_geometry/${TAG}"
