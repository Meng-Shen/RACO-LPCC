#!/usr/bin/env python3
"""Plot ShapeNet55 DGCNN fixed-quantization and learned-routing curves."""
...
def main():
    ...
    csv_path = output / "dgcnn_shapenet55_accuracy_bpp.csv"
    ...
    for axis, metric, title in [
        ...
        axis.legend()
    fig.suptitle("DGCNN geometry-only: fixed quantization vs learned routing")
    fig.tight_layout()
    png_path = output / "dgcnn_shapenet55_accuracy_bpp.png"
    ...
    summary = {
        ...
        "classifier": "DGCNN, XYZ only, public ModelNet40 initialization then ShapeNet55 fine-tuning",
