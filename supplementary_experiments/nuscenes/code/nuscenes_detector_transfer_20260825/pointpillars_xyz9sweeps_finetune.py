_base_ = [
    '/home/sm/raco_rate_aware_nuscenes_20260822/configs/pointpillars/pointpillars_hv_fpn_sbn-all_8xb4-2x_nus-3d.py'
]
...
# Remove reflectance and time at the loader; the detector receives XYZ only.
model = dict(pts_voxel_encoder=dict(in_channels=3))

train_dataloader = dict(
    batch_size=4, num_workers=3, persistent_workers=True,
    dataset=dict(
...
load_from = (
    ...
    'transfer_detectors_20260825/pointpillars_xyz_adapted.pth')
