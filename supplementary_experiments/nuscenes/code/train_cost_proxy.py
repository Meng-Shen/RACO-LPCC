...
try:
    ...
    def replace_feature(out, new_features):
        # spconv 2.x makes ``features`` read-only and exposes the functional
        # replacement API instead.  Keep the assignment fallback for the
        # older spconv builds used by some of the KITTI environments.
