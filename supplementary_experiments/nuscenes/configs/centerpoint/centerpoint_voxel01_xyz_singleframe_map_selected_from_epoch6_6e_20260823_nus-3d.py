...
work_dir = (
    ...
    'centerpoint_voxel01_xyz_singleframe_map_selected_from_epoch6_6e_20260823'
)
pretrained = (
    '/home/sm/raco_rate_aware_nuscenes_20260822/experiments/'
    'centerpoint_voxel01_xyz_singleframe_recovery_12e/epoch_6.pth'
)
...
# Second-stage geometry-only fine-tuning initialized from the previous epoch-6
# XYZ-only detector.  Optimizer state is intentionally reset and a lower LR is
# used; the previous epoch-6 checkpoint remains a candidate during final mAP
# selection so this continuation cannot silently replace it with a worse model.
