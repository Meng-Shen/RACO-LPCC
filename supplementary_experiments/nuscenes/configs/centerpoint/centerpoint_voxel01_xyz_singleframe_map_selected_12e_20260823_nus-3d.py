...
work_dir = (
    ...
    'centerpoint_voxel01_xyz_singleframe_map_selected_12e_20260823'
)
pretrained = (
...
# RTX 3090, batch 4/GPU with mixed precision. The official checkpoint was trained on nuScenes
