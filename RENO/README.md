...
python compress.py \
    --input_glob='./testdata/*.ply' \
    --output_folder='./data/testdata_compressed/' \
    --is_data_pre_quantized=True \
    --ckpt='./model/Ford/ckpt.pt' \
    --posQ=1
...
python decompress.py \
    --input_glob='./data/testdata_compressed/*.bin' \
    --output_folder='./data/testdata_decompressed/' \
    --is_data_pre_quantized=True \
    --ckpt='./model/Ford/ckpt.pt'
...
python eval.py \
    --input_glob='./testdata/*.ply' \
    --decompressed_path='./data/testdata_decompressed' \
    --pcc_metric_path='./third_party/pc_error_d' \
    --resolution=59.70
